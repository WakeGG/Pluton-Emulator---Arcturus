...
public class ConsoleInfoCommand extends ConsoleCommand {
    ...
    public void handle(String[] args) throws Exception {
        ...
        System.out.println("Versão: " + Emulator.version);
        System.out.println("BUILD: " + Emulator.build);

        System.out.println("");

        System.out.println("Estatisticas");
        System.out.println("- Users: " + Emulator.getGameEnvironment().getHabboManager().getOnlineCount());
        System.out.println("- Quartos: " + Emulator.getGameEnvironment().getRoomManager().getActiveRooms().size());
        System.out.println("- Loja:  " + Emulator.getGameEnvironment().getCatalogManager().catalogPages.size() + " paginas e " + CatalogManager.catalogItemAmount + " items.");
        System.out.println("- Mobis: " + Emulator.getGameEnvironment().getItemManager().getItems().size() + " items.");
        System.out.println("");
