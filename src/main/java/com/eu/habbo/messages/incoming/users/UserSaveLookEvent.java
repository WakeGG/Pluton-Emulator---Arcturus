...
public class UserSaveLookEvent extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        int timeSinceLastUpdate = ((int) Emulator.getIntUnixTimestamp()) - this.client.getHabbo().getHabboStats().getVisualTimestamp();
        ...
        if (lookEvent.isCancelled())
            ...
            AchievementManager.progressAchievement(this.client.getHabbo(), Emulator.getGameEnvironment().getAchievementManager().getAchievement("HaibboLooks"));
        }
    }