...
public class FloorPlanEditorSaveEvent extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (room.getOwnerId() == this.client.getHabbo().getHabboInfo().getId() || this.client.getHabbo().hasPermission(Permission.ACC_MOVEROTATE) || this.client.getHabbo().hasPermission(Permission.ACC_ANYROOMOWNER)) {
