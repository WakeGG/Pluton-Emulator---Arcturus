    ...
    public void handle() throws Exception {
        ...
        if (room != null) {
            if (room.isOwner(this.client.getHabbo()) || this.client.getHabbo().hasPermission("acc_placefurni")) {
                ...
                if (!Emulator.getGameEnvironment().getWordFilter().filter(name).equals(name)) {
                ...
                if (!Emulator.getGameEnvironment().getWordFilter().filter(description).equals(description)) {
                ...
                if (!Emulator.getGameEnvironment().getWordFilter().filter(tags.toString()).equals(tags.toString())) {
