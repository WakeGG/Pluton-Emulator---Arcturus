...
public class CommandHandler {
    ...
    public CommandHandler() {
        ...
        this.reloadCommands();
        Emulator.getLogging().logStart("Comandos carregados (" + (System.currentTimeMillis() - millis) + " MS)");
    }
    ...
    public void reloadCommands() {
        ...
        addCommand(new PremiarCommand());
        addCommand(new TestCommand());
        addCommand(new Atualizar());
        addCommand(new AlertanCommand());
        addCommand(new AqCommand());
        addCommand(new FqCommand());
        addCommand(new ConqCommand());
        addCommand(new BlockMigosCommand());
        addCommand(new PremeiaCommand());
        addCommand(new BlockMencoesCommand());
        addCommand(new CopiarQCommand());
        addCommand(new ColarQCommand());
        addCommand(new BeijarCommand());
        addCommand(new SocoCommand());
        addCommand(new AbracarCommand());
        //addCommand(new DarVIPCommand());
        addCommand(new VIPenableCommand());
        addCommand(new TrazerCommand());
        addCommand(new PullSSCommand());
        addCommand(new PushSSCommand());
        addCommand(new SexoenableCommand());
        addCommand(new BalaoVIPCommand());
        addCommand(new VoucherCommand());
        addCommand(new PublicosCommand());
        addCommand(new EventosCommand());
        addCommand(new InfoMobisCommand());
        addCommand(new VIPAlertCommand());
        addCommand(new RoomYTCommand());
        addCommand(new VIPehaCommand());
        addCommand(new StandCommand());
        addCommand(new DedoCommand());
        addCommand(new AquiohCommand());
        addCommand(new OnlinesCommand());
        addCommand(new BlockCVCommand());
        addCommand(new LajotaCommand());
        addCommand(new VenderQuartoCommand());
    }
