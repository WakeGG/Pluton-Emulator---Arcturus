...
public class HabboInfo implements Runnable {
    ...
    private String corprefixa;
    private String cornome;
    private boolean temprefix;
    ...
    public HabboInfo(ResultSet set) {
        try {
            ...
            this.corprefix = set.getString("cor_prefix");
            this.cornome = set.getString("cor_nome");
            //this.temprefix = !this.prefix.isEmpty();
    ...
    public String getcorprefix() {
        return this.corprefix;
    }

    public void setcorprefix(String corprefix) {
        this.corprefix = corprefix;
    }

    public String getcorprefixa() {
        return this.corprefixa;
    }

    public void setcorprefixa(String corprefixa) {
        this.corprefixa = corprefixa;
    }
    ...
    public boolean temPrefix() {
        return this.temprefix;
    }
    ...
    public void run() {
        ...
        try (Connection connection = Emulator.getDatabase().getDataSource().getConnection(); PreparedStatement statement = connection.prepareStatement("UPDATE users SET motto = ?, online = ?, look = ?, gender = ?, credits = ?, last_login = ?, last_online = ?, home_room = ?, ip_current = ?, `rank` = ?, machine_id = ?, username = ?, prefix = ?, cor_prefix = ?, cor_nome = ? WHERE id = ?")) {
            ...
            statement.setString(13, this.prefix);
            statement.setString(14, this.corprefixa);
            statement.setString(15, this.cornome);
