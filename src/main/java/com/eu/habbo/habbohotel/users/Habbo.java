...
public class Habbo implements Runnable {
    ...
    public void connect() {
        ...
        Emulator.getLogging().logUserLine(this.habboInfo.getUsername() + " entrou pelo IP: " + this.habboInfo.getIpLogin());
    }
    ...
    public synchronized void disconnect() {
        ...
        Emulator.getLogging().logUserLine(this.habboInfo.getUsername() + " saiu.");
        this.client = null;
    }
