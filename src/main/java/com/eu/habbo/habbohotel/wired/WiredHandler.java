...
public class WiredHandler {
    ...
    private static void giveReward(Habbo habbo, WiredEffectGiveReward wiredBox, WiredGiveRewardItem reward) {
        ...
        if (reward.badge) {
            UserWiredRewardReceived rewardReceived = new UserWiredRewardReceived(habbo, wiredBox, "emblema", reward.data);
            ...
            if (data.length == 2) {
                ...
                if (rewardReceived.type.equalsIgnoreCase("moedas")) {
                    int credits = Integer.valueOf(rewardReceived.value);
                    habbo.giveCredits(credits);
                } else if (rewardReceived.type.equalsIgnoreCase("gemas")) {
                ...
                } else if (rewardReceived.type.equalsIgnoreCase("mobi")) {
                ...
                } else if (rewardReceived.type.equalsIgnoreCase("respeitos")) {
