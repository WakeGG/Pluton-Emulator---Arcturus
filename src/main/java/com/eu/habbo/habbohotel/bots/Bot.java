...
public class Bot implements Runnable {
    ...
    public Bot(Bot bot) {
        ...
        this.chatDelay = 10;
        this.chatTimeOut = Emulator.getIntUnixTimestamp() + this.chatDelay;
        this.chatLines = new ArrayList<>(Arrays.asList("Habbo"));
    ...
    public void onPlace(Habbo habbo, Room room, Bot bot) {
        if (this.roomUnit != null) {
    ...
    public void onPickUp(Habbo habbo, Room room, Bot bot) {
        bot.setEffect(187, -1);
        bot.getEffect();
    }
    ...
    public void setChatDelay(short chatDelay) {
        ...
        if (chatDelay > 1000 || chatDelay < (Emulator.getIntUnixTimestamp() + this.chatDelay)) {
            return;
        }
    }
