...
public class WiredTriggerFurniStateToggled2 extends InteractionWiredTrigger {
    private static final WiredTriggerType type = WiredTriggerType.STATE_CHANGED;

    private THashSet<HabboItem> items;
    private String message = "";

    public WiredTriggerFurniStateToggled2(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
        this.items = new THashSet<>();
    }

    public WiredTriggerFurniStateToggled2(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
