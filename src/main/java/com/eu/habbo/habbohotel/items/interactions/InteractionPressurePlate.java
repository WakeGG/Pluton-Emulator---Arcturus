...
public class InteractionPressurePlate extends HabboItem {
    ...
    public void onWalkOff(RoomUnit roomUnit, Room room, Object[] objects) throws Exception {
        ...
        if (habbo != null && this.stepTimes.containsKey(habbo)) {
            AchievementManager.progressAchievement(habbo, Emulator.getGameEnvironment().getAchievementManager().getAchievement("WiredExpertUsePressureTile"), (Emulator.getIntUnixTimestamp() - this.stepTimes.get(habbo)) / 60);
