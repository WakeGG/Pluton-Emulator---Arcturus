...
import com.eu.habbo.habbohotel.items.interactions.games.football.InteractionFootballQQ;
...
public class ItemManager {
    ...
    public void load() {
        ...
        Emulator.getLogging().logStart("Gerenciador de items carregado (" + (System.currentTimeMillis() - millis) + " MS)");
    }
    ...
    protected void loadItemInteractions() {
        ...
        this.interactionsList.add(new ItemInteraction("football_1q", InteractionFootballQQ.class));
        ...
        this.interactionsList.add(new ItemInteraction("cor", COR.class));
        //CASINO
