...
public class InteractionFootballQQ extends InteractionPushable {

    public InteractionFootballQQ(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public InteractionFootballQQ(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
...
return 0;
    ...
    public void onMove(Room room, RoomTile from, RoomTile to, RoomUserRotation direction, RoomUnit kicker, int nextRoll, int currentStep, int totalSteps) {
        ...
        this.setExtradata(nextRoll <= 20 ? "2" : "1");
    ...
    public boolean canStillMove(Room room, RoomTile from, RoomTile to, RoomUserRotation direction, RoomUnit kicker, int nextRoll, int currentStep, int totalSteps) {
        ...
        return !(room.hasHabbosAt(to.x, to.y) && currentStep != 0);
    }
